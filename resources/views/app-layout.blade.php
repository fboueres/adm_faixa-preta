...
<html lang="pt-BR">
    ...
    <body class="flex min-h-[100vh] bg-white">
        <section class="sticky top-0 h-[100vh] w-[25vw] p-7">
            <aside
                class="border-gray-250 h-full w-full overflow-y-auto rounded-lg border-[5px] bg-gradient-to-br from-gray-100 to-gray-200 shadow-lg"
            >
                <div
                    class="mx-auto my-6 flex aspect-square h-1/4 items-center rounded-full border-8 bg-white p-3 shadow-2xl"
                >
                    <img
                        src="/img/sidebar-img.png"
                        alt="ADM Faixa Preta Ícone"
                    />
                </div>
